...
function Home() {
  ...
  const articles = articlesData.map((data, i) => {
    ...
    const toShow = !hiddenArticles.some(hiddenArticle => hiddenArticle === data.title);
    return toShow && <Article key={i} {...data} isBookmarked={isBookmarked} isBookmarkPage={false}/>;
  });
